...
<body>
  <div class="container">
    <section class="register">
      <h1>Tambah Sekolah Asal</h1>
      <form method="post" action="tbh_sek_as_save.php">
      <div>
      <h3>ID Sekolah Asal</h3>
      <input type="text" name="id_sekolah_asal" value="" required>
      <h3>Nama Sekolah</h3>
      <input type="text" name="nama_sekolah_asal" value="" required>
      <h3>Alamat Sekolah</h3>
      <input type="text" name="alamat_sekolah_asal" value="" required>
      </div>
